...
function Testimonials() {
    const [testimonials,setTestimonials] = useState([{name:"",image:"",testimony:""}]);


    useEffect(() => {
        fetch('https://my-json-server.typicode.com/SamoudiAnas/burger-shop/testimonials')
            .then(res => res.json())
